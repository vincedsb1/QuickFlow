...
function ContextMenuAlternative() {
  ...
  return (
    <div className="w-60 absolute mt-3 rounded-md py-5 px-7 text-base drop-shadow-lg border bg-white font-bold text-slate-900 origin-right -translate-x-3/4">
      <NavLink to="/account">
...
export default ContextMenuAlternative;
